...
namespace bibliotecaUDB.Controllers
{
    public class MiembrosController : Controller
    {
        ...
        public MiembrosController(LibraryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreCompleto,Email")] Miembro miembro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreCompleto,Email")] Miembro miembro)
        {
            if (id != miembro.Id)
            {
                return NotFound();
